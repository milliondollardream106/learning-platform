// pages/courses/cs103/unit-1/lesson-2.2.tsx
"use client";
...
import { lessonContent } from "../../../../../../content/cs103-2-2";
            ...
            <main className="w-full max-w-[1200px] p-8 md:p-16">
              ...
              {lessonContent.sections[0].items.map((item) => (
                <LessonSection
                  ...
                  imagePath={item.imagePath || null} // Pass imagePath here
                />
              ))}

              <div className="pt-8 flex justify-end">
                <Link href="/courses/cs103/unit-2/lesson-2.3">
