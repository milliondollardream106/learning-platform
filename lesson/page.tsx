        ...
        return (
          <ul key={index} className="list-disc pl-6 space-y-2 mt-4">
            {items.map((item, itemIndex) => (
              <li key={itemIndex} className="text-gray-700 leading-loose text-lg tracking-wide">
                {item.trim()}
              </li>
            ))}
          </ul>
            ...
            <main className="w-full max-w-[1200px] p-8 md:p-16">
              ...
              <div className="flex flex-col lg:flex-row items-start gap-6">
                ...
                <div className="flex-[0.6]">
                  ...
                  Learn how to solve complex problems like a computer scientist. Master the fundamental 
                  concepts and methodologies of computational thinking that will enhance your problem-solving 
                    abilities and prepare you for success in computer science and beyond.
                  </p>
                </div>
